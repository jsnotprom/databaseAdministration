...
<div class="container mt-5">
    <h2 class="left-align mb-4">Add New User</h2>
    ...
    <form action="addUser.php" method="POST">
        ...
        <button type="submit" class="btn btn-primary mb-5 w-20">Add User</button>
        </div>
    </form>

<h2 class="left-align mb-4">User Information</h2>
                    ...
                    echo "<tr>
                            ...
                            <td>
                                <form action='deleteUser.php' method='POST' style='display:inline;'>
                                    <input type='hidden' name='userInfoID' value='" . htmlspecialchars($row['userInfoID']) . "'>
